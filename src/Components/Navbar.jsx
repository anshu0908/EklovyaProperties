    ...
    <div className="absolute top-0 left-0 w-full z-50 bg-transparent">
      <div className="flex justify-between items-center px-6 md:px-10 py-4 md:py-6 flex-wrap">
        ...
        <div className="flex items-center gap-4 md:gap-6 text-sm md:text-base">
          ...
          <button className="text-white border border-white px-4 py-1.5 md:px-5 md:py-2 rounded-full font-semibold hover:bg-white hover:text-black transition whitespace-nowrap">
            Contact Us
          </button>
        </div>
      </div>
